    ...
    <div className='flex w-full h-full bg-[url("/src/assets/img/collection-boxes.png")] bg-no-repeat bg-right relative'>
      ...
      <div
        ...
        <div className='flex items-center justify-end p-6 space-x-5 mt-auto'>
          <button
            className='w-20 h-10 border border-gray-300 rounded-md text-gray-700 text-sm font-medium shadow-sm'
            onClick={() => setShowPanel(false)}>
            Cancel
          </button>
          <button className='w-20 h-10 bg-primary rounded-md text-white text-sm font-medium shadow-sm hover:opacity-70'>
            Create
          </button>
        </div>
      </div>
